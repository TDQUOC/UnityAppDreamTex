...
namespace Alta.Tools
{
    public class WebcamController : MonoBehaviour
    {
        ...
        public bool originRatio= true;
        private AspectRatioFitter uiRatio;
        public virtual void Awake()
        {
            uiRatio = GetComponent<AspectRatioFitter>();
        }
        ...
        public virtual void Play()
        {
            ...
            if(this.originRatio && this.uiRatio != null)
            {
                this.uiRatio.aspectRatio = webcam.width / (webcam.height*1f);
            }
        }
